...
private:
  ...
  int fPid;     // PID code for the particle species
  int fTrackId; // Track id, can be used to differentiate different track types,
                // e.g. reconstructed in different parts of the detector
...
public:
   ...
   * @param R Closest distance between particle track and beam line.
   * @param Z Point along the beam line where the particle passes closest.
   */
  ...
  void setThetaRad(double val) {
    fTheta = val;
    cand.SetTheta(val);
  } // Sets the polar angle [radians]
  void setPhiRad(double val) {
    fPhi = val;
    cand.SetTheta(val);
  } // Sets the azimuthal angle [radians]
  void setThetaDeg(double val) {
    fTheta = val * TMath::DegToRad();
    cand.SetTheta(val * TMath::DegToRad());
  } // Sets the polar angle [deg]
  void setPhiDeg(double val) {
    fPhi = val * TMath::DegToRad();
    cand.SetTheta(val * TMath::DegToRad());
  } // Sets the azimuthal angle [deg]
  ...
  void setPid(int val) {
    fPid = val;
  } // Sets the PID of the particle (user defined)
  ...
  void setGenVertexX(double val) {
    fGenVtxX = val;
  } // Sets the generated x-vertex [mm]
  void setGenVertexY(double val) {
    fGenVtxY = val;
  } // Sets the generated y-vertex [mm]
  void setGenVertexZ(double val) {
    fGenVtxZ = val;
  } // Sets the generated z-vertex [mm]
  ...
  void setGenMomentum(double val) {
    fGenMomentum = val;
  } // Sets the momentum [MeV/c]
  void setGenThetaDeg(double val) {
    fGenTheta = val;
  } // Sets the polar angle [deg]
  void setGenPhiDeg(double val) {
    fGenPhi = val;
  } // Sets the azimuthal angle [deg]
  ...
  double getMomentum() const {
    return fMomentum;
  } // Returns the momentum [MeV/c]
  double getThetaRad() const {
    return fTheta;
  } // Returns the polar angle [radians]
  double getPhiRad() const {
    return fPhi;
  } // Returns the azimuthal angle [radians]
  double getThetaDeg() const {
    return fTheta * TMath::RadToDeg();
  } // Returns the polar angle [deg]
  double getPhiDeg() const {
    return fPhi * TMath::RadToDeg();
  } // Returns the azimuthal angle [deg]
  double getGenThetaDeg() const {
    return fGenTheta;
  } // Returns the generated polar angle [deg]
  double getGenPhiDeg() const {
    return fGenPhi;
  } // Returns the generated azimuthal angle [deg]
  ...
  double getGenVertexX() const {
    return fGenVtxX;
  } // Returns the generated x-vertex [mm]
  double getGenVertexY() const {
    return fGenVtxY;
  } // Returns the generated y-vertex [mm]
  double getGenVertexZ() const {
    return fGenVtxZ;
  } // Returns the generated z-vertex [mm]
